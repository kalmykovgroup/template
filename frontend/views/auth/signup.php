...
use frontend\assets\Auth\SignupAsset;
...
<div class="site-signup">
    ...
    <div class="centerBlockForm">
        ...
        <div class="titleBlock">Регистрация в два клика</div>
        ...
        <div class="text_t235664">с помощью:</div>
        <div class="methodSelection methodSelectionSignup">
        ...
        <div class="blockServices">
            ...
            <div class="title">Регистрация с помощью соц. сетей:</div>
