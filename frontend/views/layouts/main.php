...
<header>
    <?php
    NavBar::begin([
        'brandLabel' => "Строй Хоз <span class='brandEndWord'>Маг</span>",
    ...
    if (Yii::$app->user->isGuest) {
        ...
        echo Html::beginForm(['/auth/logout'], 'post', ['class' => 'd-flex'])
            . Html::submitButton(
                'Logout (' . ($_SESSION['username'] ?? Yii::$app->user->id ?? "User" ) . ')',
...
<main role="main" class="flex-shrink-0">
    ...
    <div class="wrap">
        <div id="topBlockSearch">


            <div class="topBlockSearchMainCenter">
                <div class="topBlockSearch_left">
                </div>

                <div class="topBlockSearch_center">
                    ...
                    <div class="b1_right">
                        <?php if(isset($_SESSION['qty_product'])): ?>
                            <div style="display: flex" class="qty_product"><?=$_SESSION['qty_product'];?></div>
                            <div style="display: none" class="empty_qty_product">Пусто</div>
                        <?php else: ?>
                            <div style="display: none" class="qty_product">0</div>
                            <div style="display: flex" class="empty_qty_product">Пусто</div>
                        <?php endif; ?>


                        <a href="/cart/view" class="a_btn_cart">
                ...
                <div class="topBlockSearch_right"></div>
