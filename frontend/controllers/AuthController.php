...
class AuthController extends Controller
{
     ...
     * @throws NotFoundHttpException
     */
    public function actionLogin(): array|Response|false|string|\yii\console\Response
    {
        ...
        try{
            ...
            if(!Yii::$app->user->isGuest){
                ...
                if(Yii::$app->request->isAjax)
                    return ['result' => 'success', 'referrer '=> $_SESSION[self::RedirectUrl] ?? '/'];
                else
            ...
            Yii::error($e);
                ...
                if(Yii::$app->request->isAjax)
                    return ['result' => 'error', 'errors' => ['unknown' => $e->getMessage()]];
                else
